  ...
  return (
    ...
    >
      ...
      <section className="relative min-h-[620px] overflow-hidden pb-10 md:min-h-[720px] md:pb-14">
        {/* HERO BACKGROUND */}
        <div className="pointer-events-none absolute inset-x-0 top-0 z-[1] h-16 bg-[#f5f3ee] md:hidden" />
        <div className="absolute inset-x-0 -top-12 z-0 h-[500px] overflow-hidden md:top-0 md:h-[720px]">
          <div className="absolute inset-0 h-full overflow-hidden md:left-auto md:right-0 md:w-[64vw] md:min-w-[780px]">
            <Image
              ...
              className="object-cover object-[70%_24%] -translate-y-8 scale-[1.08] opacity-35 contrast-105 saturate-105 brightness-105 md:translate-y-0 md:scale-100 md:object-[75%_center] md:opacity-100 md:contrast-110 md:saturate-110"
            />
            ...
            <div className="pointer-events-none absolute inset-x-0 bottom-0 h-40 bg-gradient-to-t from-[#f5f3ee] via-[#f5f3ee]/80 to-transparent md:h-64" />
          </div>
        </div>
