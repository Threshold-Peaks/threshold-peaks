...
export default async function Home() {
  ...
  return (
    ...
    >
      {/* HERO */}
      <section className="relative min-h-[620px] overflow-hidden pb-10 md:min-h-[100svh] md:pb-14">
        {/* HERO BACKGROUND */}
        <div className="pointer-events-none absolute inset-x-0 top-0 z-[1] h-16 bg-[#f5f3ee] md:hidden" />
        <div className="absolute inset-x-0 -top-12 z-0 h-[500px] overflow-hidden md:top-0 md:h-[clamp(720px,100svh,980px)]">
